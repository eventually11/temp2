...
# Usage
saas_partner_faker = SaasPartnerFaker()
fake_partner_task = saas_partner_faker.generate_saas_partner_task()
fake_partner_task_event_log = saas_partner_faker.generate_saas_partner_task_event_log()
fake_partner_task_validation_step = saas_partner_faker.generate_saas_partner_task_validation_step()
fake_partner_task_partner_fee = saas_partner_faker.generate_saas_partner_task_partner_fee()
